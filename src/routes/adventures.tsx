...
function PhilosophySection({ philosophy }: { philosophy: AdventuresPage["philosophy"] }) {
  return (
    <section className="py-24 md:py-32 bg-cream">
      <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
        <p className="text-[11px] tracking-[0.3em] uppercase text-terracotta mb-6">
          {philosophy.eyebrow}
        </p>
...
function TerrainsSection({ terrains }: { terrains: AdventuresPage["terrains"] }) {
    ...
    <section className="py-24 border-b border-border/40">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-foreground max-w-2xl">
              {terrains.length} landscapes, one continent.
            </h2>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-border/60">
          {terrains.map((t, i) => (
            <div key={`${t.label}-${i}`} className="bg-background p-8 hover:bg-cream transition-colors">
              <Icon name={t.icon} className="w-7 h-7 text-terracotta mb-5" />
...
function StylesSection({ styles }: { styles: AdventuresPage["styles"] }) {
    ...
    <section className="py-24 bg-forest text-forest-foreground">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {styles.map((s, i) => (
            <div key={`${s.title}-${i}`} className="border-l border-gold/40 pl-6 py-1">
              <Icon name={s.icon} className="w-6 h-6 text-gold mb-4" />
