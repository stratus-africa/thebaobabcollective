...
export async function sendPlanningGuideEmails(args: SendArgs) {
  ...
  const requesterHtml = `
    <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;padding:32px;color:#1f2a24;">
      ...
      ${args.pdfUrl
        ? `<p style="margin:28px 0;"><a href="${args.pdfUrl}" style="background:#c79849;color:#1f2a24;text-decoration:none;padding:14px 22px;letter-spacing:2px;text-transform:uppercase;font-size:11px;font-family:Helvetica,Arial,sans-serif;">Download the Guide (PDF)</a></p>`
