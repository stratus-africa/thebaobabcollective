...
const groups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/pages/detail_adventure", label: "Adventure Detail Template", icon: Compass },
      { to: "/admin/pages/detail_lodge", label: "Lodge Detail Template", icon: Building },
      { to: "/admin/pages/detail_destination", label: "Destination Detail Template", icon: MapPin },
